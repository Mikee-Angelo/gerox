        ...
        <div class="card ">
            ...
            <div class="card-body">
                <?php echo form_open('')?>
                    <div class="form-group">
                        <input class="form-control form-control-lg <?php echo (form_error('main_id') ? 'is-invalid' : '');?>" id="main_id" type="text" value="<?php echo set_value('main_id');?>" placeholder="ID/Email" name="main_id" autocomplete="off" >
            ...
            <div class="card-footer bg-white p-0  text-center">
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="<?php echo base_url();?>forgot_pwd" class="footer-link ">Forgot Password</a>
                </div>
            </div>
        </div>
    </div>
